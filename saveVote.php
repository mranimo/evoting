    ...
    <div class="container" style="padding-top:150px;">
    	<div class="row">
          ...
          require('config.php');
					...
					if(isset($_POST["name"]) && isset($_POST["voterid"]) && isset($_POST["selectedCandidate"]))
					{
						$name= test_input($_POST["name"]);
						$vid= test_input($_POST["voterid"]);
       ...
       $DB_HOST= "sql108.liveblog365.com";
       $DB_USER="lblog_31659286";
       $DB_PASSWORD="hyder1234";
       $DB_NAME="lblog_31659286_1";
       ...
       // $sq="select * from sampledb where namee='$name' and voterid='$vid'";
       // $resultset=mysqli_query($conn,$sq);
        if(1)
        {
          $s="voted";
          $sql= "INSERT INTO tbl_users(full_name,voterid,voted_for,status) VALUES ('$name','$vid','$selection','$s')";
          ...
          else
          {
            echo "<img src='images/error.png' width='70' height='70'>";
					echo "<h3 class='text-info specialHead text-center'><strong> SORRY! You had already voted</strong></h3>";
					echo "<a href='index.html' class='btn btn-primary'> <span class='glyphicon glyphicon-ok'></span> <strong> Finish</strong> </a>";
          }
        }
				else
				{
					echo "<img src='images/error.png' width='70' height='70'>";
					echo "<h3 class='text-info specialHead text-center'><strong> SORRY INCORRECT CREDENTIALS..</strong></h3>";
					echo "<a href='index.html' class='btn btn-primary'> <span class='glyphicon glyphicon-ok'></span> <strong> Finish</strong> </a>";
				}
